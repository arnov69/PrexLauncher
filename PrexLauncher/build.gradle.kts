...
val nameId = "com.prexlauncher"
val generatedPrexDir = file("$buildDir/generated/source/prex/java")
...
android {
    ...
    sourceSets["main"].java.srcDirs(generatedPrexDir)
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedPrexDir, "com.prexlauncher", "InfoDistributor", constantMap)
    }
}
