package com.prexlauncher.ui.fragment.about
...
import com.prexlauncher.databinding.FragmentAboutInfoPageBinding
import com.prexlauncher.ui.dialog.TipDialog
import com.prexlauncher.ui.subassembly.about.AboutItemBean
import com.prexlauncher.ui.subassembly.about.AboutItemBean.AboutItemButtonBean
import com.prexlauncher.ui.subassembly.about.AboutRecyclerAdapter
...
class AboutInfoPageFragment() : Fragment(R.layout.fragment_about_info_page) {
    ...
    private fun loadAboutData(resources: Resources) {
        ...
        mAboutData.add(
            AboutItemBean(
                resources.getDrawable(R.drawable.image_about_prex, requireContext().theme),
                "arnov69",
                getString(R.string.about_arnov69_desc),
                AboutItemButtonBean(
                    requireActivity(),
                    getString(R.string.about_access_link),
                    "https://github.com/arnov69"
                )
            )
        )
        mAboutData.add(
