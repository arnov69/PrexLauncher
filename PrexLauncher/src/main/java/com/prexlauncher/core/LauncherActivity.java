...
import static com.prexlauncher.launch.LaunchGame.preLaunch;
import static com.prexlauncher.core.Tools.currentDisplayMetrics;
...
import com.prexlauncher.databinding.ActivityLauncherBinding;
import com.prexlauncher.event.single.LaunchGameEvent;
import com.prexlauncher.event.single.MainBackgroundChangeEvent;
import com.prexlauncher.event.single.PageOpacityChangeEvent;
import com.prexlauncher.event.single.SwapToLoginEvent;
import com.prexlauncher.event.sticky.MinecraftVersionValueEvent;
import com.prexlauncher.event.value.AddFragmentEvent;
import com.prexlauncher.event.value.DownloadProgressKeyEvent;
import com.prexlauncher.event.value.InstallGameEvent;
import com.prexlauncher.event.value.InstallLocalModpackEvent;
import com.prexlauncher.event.value.LocalLoginEvent;
import com.prexlauncher.event.value.MicrosoftLoginEvent;
import com.prexlauncher.event.value.OtherLoginEvent;
import com.prexlauncher.feature.accounts.AccountType;
import com.prexlauncher.feature.accounts.AccountsManager;
import com.prexlauncher.feature.accounts.LocalAccountUtils;
import com.prexlauncher.feature.background.BackgroundManager;
import com.prexlauncher.feature.background.BackgroundType;
...
import com.prexlauncher.feature.mod.modpack.install.InstallLocalModPack;
import com.prexlauncher.feature.mod.modpack.install.ModPackInfo;
import com.prexlauncher.feature.mod.modpack.install.ModPackUtils;
import com.prexlauncher.feature.notice.CheckNewNotice;
import com.prexlauncher.feature.notice.NoticeInfo;
import com.prexlauncher.feature.update.UpdateUtils;
import com.prexlauncher.feature.version.Version;
import com.prexlauncher.feature.version.VersionsManager;
import com.prexlauncher.feature.version.install.GameInstaller;
import com.prexlauncher.feature.version.install.InstallTask;
import com.prexlauncher.plugins.renderer.RendererPlugin;
import com.prexlauncher.plugins.renderer.RendererPluginManager;
import com.prexlauncher.setting.AllSettings;
import com.prexlauncher.task.Task;
import com.prexlauncher.task.TaskExecutors;
import com.prexlauncher.ui.activity.BaseActivity;
import com.prexlauncher.ui.activity.ErrorActivity;
import com.prexlauncher.ui.dialog.EditTextDialog;
...
import com.prexlauncher.utils.StoragePermissionsUtils;
...
import com.prexlauncher.core.authenticator.microsoft.MicrosoftBackgroundLogin;
import com.prexlauncher.core.contracts.OpenDocumentWithExtension;
import com.prexlauncher.core.fragments.MainMenuFragment;
import com.prexlauncher.core.prefs.LauncherPreferences;
import com.prexlauncher.core.progresskeeper.ProgressKeeper;
import com.prexlauncher.core.progresskeeper.TaskCountListener;
import com.prexlauncher.core.services.ProgressServiceKeeper;
import com.prexlauncher.core.tasks.AsyncVersionList;
import com.prexlauncher.core.utils.NotificationUtils;
