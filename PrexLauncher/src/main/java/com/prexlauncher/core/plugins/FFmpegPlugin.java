package com.prexlauncher.core.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.prexlauncher.core.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
