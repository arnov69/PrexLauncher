...
import com.prexlauncher.feature.version.VersionsManager.getPrexVersionPath
import com.prexlauncher.setting.AllSettings
import com.prexlauncher.utils.stringutils.StringUtils.getStringNotNull
...
class VersionConfig(private var versionPath: File) : Parcelable {
    ...
    fun saveWithThrowable() {
        ...
        val zalithVersionPath = getPrexVersionPath(versionPath)
    ...
    companion object CREATOR : Parcelable.Creator<VersionConfig> {
        ...
        fun parseConfig(versionPath: File): VersionConfig {
            ...
            val oldConfigFile = File(getPrexVersionPath(versionPath), "PrexVersion.cfg")
            val configFile = File(getPrexVersionPath(versionPath), "VersionConfig.json")
