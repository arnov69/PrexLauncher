package com.prexlauncher.feature.update
...
import com.prexlauncher.feature.update.LauncherVersion.FileSize
...
import com.prexlauncher.ui.dialog.UpdateDialog
import com.prexlauncher.utils.path.PathManager
import com.prexlauncher.utils.ZHTools
import com.prexlauncher.utils.http.CallUtils
import com.prexlauncher.utils.http.CallUtils.CallbackListener
...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/arnov69/PrexLauncher/releases/download/" +
                    "${launcherVersion.versionCode}/PrexLauncher-${launcherVersion.versionName}" +
